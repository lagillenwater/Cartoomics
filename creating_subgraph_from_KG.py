...
def main():
    ...
    if pdp == 'true':
        ...
        if cosine_similarity == 'true':
            ...
            subgraph_pdp,path_pdp,all_chosen_path_nodes = subgraph_prioritized_path_pdp(s,g.igraph,g.igraph_nodes,g.labels_all,g.edgelist,weights,search_type,pdp_weight,output_dir,kg_type,all_chosen_path_nodes)
    ...
    if guiding_term:
        ...
        for t in tqdm(range(len(guiding_term_df))):
            ...
            if cosine_similarity == 'true' or pdp == 'true':
                ...
                subgraph_guiding_term,all_paths_cs_values,output_foldername = subgraph_prioritized_path_guiding_term(s,term_row,g.igraph,g.igraph_nodes,g.labels_all,g.edgelist,weights,search_type,triples_list_file,output_dir,input_dir,embedding_dimensions,kg_type,all_chosen_path_nodes)
